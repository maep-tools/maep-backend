...
class UserService
{
     ...
     * @return User
     */
    public function create($user, $password, $role = 'Miembro', $sendEmail = true, $data = ["company" => 'Ejemplo', "phone" => '123456'])
    {
        try {
            DB::transaction(function () use ($user, $password, $role, $sendEmail, $data) {
            ...
            var_dump($e);
            throw new Exception("We were unable to generate your profile, please try again later.", $e);
        }
    }
            ...
            return DB::transaction(function () use ($userId, $payload) {
                ...
                if (isset($payload['roles'])) {
                    ...
                    foreach ($payload['roles'] as $rol) {
                        if ($rol) {
                            $this->assignRole($rol['name'], $userId);
                        }
                    }
