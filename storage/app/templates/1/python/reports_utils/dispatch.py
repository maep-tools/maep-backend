def gendispatch(scenarios,stages):
    import json
    import pickle
    ...
    for z in range(numAreas):
        ...
        dataJson = json.dumps([Wind, Batteries, Small, Hydro, Thermal, Deficit],indent=4, sort_keys=True, default=str)#Deficit, Thermal, Hydro, Small, Batteries, Wind]
        jsonFile= open("results/areasdispatch_reportData/" + areasname[z] +".txt","w")
    ...
    jsonFile= open("results/areasdispatch_reportDataGeneral.txt","w")
